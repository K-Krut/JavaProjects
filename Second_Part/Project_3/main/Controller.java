...
public class Controller implements Command {
    ...
    class StrategyPoint implements Strategy {
        ...
        @Override
        public void Action(Double x, Double y, Double height, Double width) throws Exception {
            Point_Class PointObject = model.Point_Class(x, y);
            AnnotationMethodInvoke(PointObject, Point_Class.class);
            gettingClassMethods(PointObject);
            getAnnotations(PointObject);
            ToString(PointObject);
            gettingClassModifier(PointObject);
            getConstructors(PointObject);
            gettingClassFields(PointObject);
            NameClass(Point_Class.class);
            gettingInterfaces(Point_Class.class);
    ...
    class StrategyRectangular implements Strategy {
        ...
        public void Action(Double x, Double y, Double height, Double width) throws Exception {
            ...
            gettingClassMethods(RectangularObject);
            getAnnotations(RectangularObject);
            ToString(RectangularObject);
            gettingClassModifier(RectangularObject);
            getConstructors(RectangularObject);
            gettingClassFields(RectangularObject);
            NameClass(Rectangular.class);
            gettingInterfaces(Rectangular.class);
